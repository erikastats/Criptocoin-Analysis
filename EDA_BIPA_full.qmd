...
O Growth Rate é útil para medir tendência, mas ele precisa ser interpretado junto ao volume absoluto de usuários. Em bases pequenas, variações percentuais podem parecer desproporcionais, então recomendo sempre acompanhar as duas métricas lado a lado
